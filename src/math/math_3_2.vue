...
export default {
  ...
  methods: {
    ...
    generate: function () {
      ...
      switch (type) {
        case 2:
          this.first = this.random(0, 99);
          this.second = this.random(0, this.first);
          this.op = "-";
          break;
        case 1:
          this.second = this.random(0, 99);
          this.first = this.random(0, 99 - this.second);
          this.op = "+";
          break;
        default:
          this.first = this.random(0, 99);
          this.second = this.random(0, 99 - this.first);
          this.op = "+";
          break;
      }
